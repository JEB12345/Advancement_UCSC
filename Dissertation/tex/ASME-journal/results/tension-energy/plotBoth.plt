...
set key width 2 height 2 enhanced spacing 2
...
set term postscript eps enhanced font my_font
#set term aqua 0
#set term x11 0
#set title "Learning Rolling Locomotion using Coevolutionary Algorithms"
set key right top
set xlabel "Time (s)"
set ylabel "Length (m)"
set xrange [20:40]
...
set output "lengths.eps"

set yrange [0.82:0.94]
plot\
 "../testing/logs/muscleLengthsAveMax.csv" using 1:2 title "Average Actual Length"  w l,\
  "../testing/logs/muscleRestLengthsAveMax.csv" using 1:2 title "Average Rest Length"  w l
...
plot\
 "../testing/logs/muscleEnergyAveMax.csv" using 1:2 notitle   w l

#------
set output "tensions.eps"
set ylabel "Tensions (N)"
set yrange [0:200]

plot\
 "../testing/logs/muscleTensionsAveMax.csv" using 1:2 title "Average Tension"  w l,\
 "../testing/logs/muscleTensionsAveMax.csv" using 1:3 title "Max Tension" w l

#------
set output "tensPotEnergy.eps"
set ylabel "Energy (J)"
set yrange [0:130]

plot\
 "../testing/logs/tensPotEnergy.csv" using 1:2 notitle  w l

#------
set output "tensKinEnergy.eps"
set ylabel "Energy (J)"
set yrange [0:30]

plot\
 "../testing/logs/tensKinEnergy.csv" using 1:2 notitle  w l smooth csplines
