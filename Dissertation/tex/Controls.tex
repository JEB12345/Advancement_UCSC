...
\begin{figure}[thbp]
    ...
    \caption{
    This figure shows the tracked center of mass of a simulated \SB{} utlizing the basic steering controller.
    This controller has no feed back and does have a slight bias toward turning right more than left.
    It is assumed this is because of the modeled issues issues outlined in appendix~\ref{app:evalutation}.
