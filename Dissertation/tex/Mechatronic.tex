...
The main processing unit on the power board is Microchip's 16-bit mirco-controller, dsPIC33ep128mc506. % be careful of the long random strings. they can run over margins
